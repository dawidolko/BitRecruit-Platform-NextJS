          ...
          <header className={s.groupHeader}>
            ...
            <div className={s.groupButtons}>
              <Button
                ...
                <IconChevronUp
                  className={`${s.groupToggleIcon} ${categoriesOpened ? s.groupToggleIconOpened : ""}`}
                />
              </Button>
            </div>
          </header>
            ...
            <div className={s.groupLeft}>
              ...
              {hasFilter("technologies") && (
                <Button
                  ...
                  size="compact-xs"
                  variant="outline"
                  onClick={() => clearFilter("technologies")}>
                  <IconX size={14} />
                </Button>
              )}
            </div>
          ...
          <header className={s.groupHeader}>
            ...
            <div className={s.groupButtons}>
              <Button
                ...
                variant="transparent"
                className={s.groupButton}
                onClick={salaryToggle}>
                <IconChevronUp
                  className={`${s.groupToggleIcon} ${salaryOpened ? s.groupToggleIconOpened : ""}`}
                />
              </Button>
            </div>
          </header>
          ...
          <header className={s.groupHeader}>
            <div className={s.groupLeft}>
              ...
              {hasFilter("seniorities") && (
                <Button
                  ...
                  size="compact-xs"
                  variant="outline"
                  onClick={() => clearFilter("seniorities")}>
                  <IconX size={14} />
                </Button>
              )}
            </div>
            <div className={s.groupButtons}>
              <Button
                ...
                variant="transparent"
                className={s.groupButton}
                onClick={seniorityToggle}>
                <IconChevronUp
                  className={`${s.groupToggleIcon} ${seniorityOpened ? s.groupToggleIconOpened : ""}`}
                />
              </Button>
            </div>
          </header>
